...
namespace CellsAtWork
{
    public class DBManager
    {
        ...
        static string DB_Connection_String = @"Data Source=DESKTOP-NF0CFJ8\SQLEXPRESS;Initial Catalog=Project;Integrated Security=True;MultipleActiveResultSets=true";
